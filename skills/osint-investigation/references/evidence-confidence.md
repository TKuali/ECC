...
The CSV helper preserves source text verbatim. When opening a ledger in a
spreadsheet, import all fields as text; do not evaluate formulas from untrusted
claims, titles, or notes. Keep the original evidence separate from presentation
exports so display changes cannot silently alter the source record.
