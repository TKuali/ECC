...
The states gate a definitive conclusion, not the ability to return a useful
report. A blocked conclusion can still be reported as provisional when access,
budget, or evidence limits prevent further progress.
...
Definitive-conclusion status: **blocked**.
...
Definitive-conclusion status: **allowed**.

### `REOPENED`

A rejection, contradiction, or newly discovered artifact invalidated the previous convergence state.

Definitive-conclusion status: **blocked** until the gate passes again.
...
- the agreed time or action budget is exhausted;
