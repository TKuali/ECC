...
Do not execute malware, download samples, exploit systems, obtain credentials, or engage criminal infrastructure in this public-source workflow. Use hashes and trusted analysis summaries; active sample analysis belongs in a separately scoped environment.
